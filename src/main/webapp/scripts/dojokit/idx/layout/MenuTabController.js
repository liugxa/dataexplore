	...
	var MenuTabController = declare("idx.layout.MenuTabController", [ScrollingTabController], {
		...
		onAddChild: function(/*dijit._Widget*/ page, /*Integer?*/ insertIndex){
			...
			var hoverTimeout = null, exitHoverHandle = null, enterHoverHandle = null, 
				exitTabHandle = null, enterTabHandle = null, closeHandle = null, cleanupTime = 0;
			...
			var cleanupPopup = lang.hitch(this, function(e) {
				...
				exitHoverHandle = enterHoverHandle = exitTabHandle = enterTabHandle = closeHandle = null;
			...
			var showPagePopup = lang.hitch(this, function(e) {
				...
				mbox = domGeometry.getMarginBox(button.focusNode);
			...
			this._handles[page.id].push(
				on(button.domNode, "click", lang.hitch(this, function(e) {
					...
					if (page === container.selectedChildWidget) popup = showPagePopup(e);
					if (popup) event.stop(e);
				}))
			);
